...
mongoose.connect(config.mongoDB.uri,{useNewUrlParser:true}).then((err,db) => {
...
app.listen(config.port,() => console.log(`app running in ${config.envName}, listening on port ${config.port}`));
